    ...
    <section id="venue" className="venue-section">
      <div className="venue-content">
        ...
        <p className="venue-description">
          ...
          the perfect place to get married. We fell in love with Snow Farm from the second we
        ...
        <img src="/assets/images/9c608a_4f46c80b727741b0ab89c97f4a108f02~mv2.png" alt="Snow Farm Logo" className="venue-logo" />
      </div>
